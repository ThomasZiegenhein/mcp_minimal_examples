...
if __name__ == "__main__":
    ...
    mcp.run(transport="streamable-http", host="0.0.0.0", port=8810, path="/mcp") # 127.0.0.1 will fail when dockerized! 127.0.0.1 is private to the container and will not work via portforwarding!
